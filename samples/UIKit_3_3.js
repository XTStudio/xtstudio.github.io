...
var HelloViewController = /** @class */ (function (_super) {
    ...
    HelloViewController.prototype.viewDidLoad = function () {
        ...
        this.view.addConstraints(UI.LayoutConstraint.constraintsWithVisualFormat("H:[yellowView(50%),grayView(100)]", this));
        this.view.addConstraints(UI.LayoutConstraint.constraintsWithVisualFormat("V:|-100-[yellowView(44)]-44-[grayView(22)]", this));
        this.view.addConstraints(UI.LayoutConstraint.constraintsWithVisualFormat("C:yellowView.centerX(_)", this));
        this.view.addConstraints(UI.LayoutConstraint.constraintsWithVisualFormat("C:grayView.centerX(yellowView)", this));
