...
var HelloViewController = /** @class */ (function (_super) {
    ...
    HelloViewController.prototype.viewDidLoad = function () {
        ...
        this.view.addConstraints(UI.LayoutConstraint.constraintsWithVisualFormat("H:|-0-[grayView(100)]-0-[yellowView]-0-|", this));
        this.view.addConstraints(UI.LayoutConstraint.constraintsWithVisualFormat("V:|-0-[yellowView]-0-|", this));
        this.view.addConstraints(UI.LayoutConstraint.constraintsWithVisualFormat("V:|-0-[grayView]-0-|", this));
