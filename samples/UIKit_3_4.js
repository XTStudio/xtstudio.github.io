...
var HelloViewController = /** @class */ (function (_super) {
    ...
    HelloViewController.prototype.viewDidLoad = function () {
        ...
        this.view.addConstraints(UI.LayoutConstraint.constraintsWithVisualFormat("H:|-15-[yellowView(50%)]", this));
        this.view.addConstraints(UI.LayoutConstraint.constraintsWithVisualFormat("V:|-100-[yellowView(yellowView.width*1.5)]", this));
